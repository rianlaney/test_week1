...
for (let i =0; i<fujiAcres.length; i++){
    ...
    galaPounds +=fujiTons[i] * 2000
    pinkPounds +=fujiTons[i] * 2000
...
console.log(`FujiProfit: ${fujiProfit}cents`)
console.log(`GalaProfit: ${galaProfit}cents`)
console.log(`FujiProfit: ${pinkProfit}cents`)
